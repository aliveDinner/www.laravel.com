...
class DbManager extends BaseManager
{
    ...
    public $db = 'db';
    /**
     * @var \app\Components\access\AuthItem string the name of the table storing authorization items. Defaults to "auth_item".
     */
    public $itemTable = 'app\Components\access\AuthItem';
    /**
     * @var \app\Components\access\AuthItemChild string the name of the table storing authorization item hierarchy. Defaults to "auth_item_child".
     */
    public $itemChildTable = 'app\Components\access\AuthItemChild';
    /**
     * @var \app\Components\access\AuthAssignment string the name of the table storing authorization item assignments. Defaults to "auth_assignment".
     */
    public $assignmentTable = 'app\Components\access\AuthAssignment';
    /**
     * @var \app\Components\access\AuthRule string the name of the table storing rules. Defaults to "auth_rule".
     */
    public $ruleTable = 'app\Components\access\AuthRule';
    /**
    ...
    /**
     * @return \app\Components\access\DbManager
     */
