...
if (!class_exists('QRcode', false)) {
	...
	class QRcode {
		...
		protected function encodeMask($mask) {
			...
			$this->frame = $this->neApp\Componentsrame($this->version);
			$this->x = $this->width - 1;
			$this->y = $this->width - 1;
			$this->dir = -1;
			$this->bit = -1;
		 ...
		 * @return array bitstream
		 */
		 protected function neApp\ComponentsromNum($bits, $num) {
		 ...
		 * @return array bitstream
		 */
		 protected function neApp\ComponentsromBytes($size, $data) {
		 ...
		 */
		 protected function appendNum($bitstream, $bits, $num) {
			...
			$b = $this->neApp\ComponentsromNum($bits, $num);
		 ...
		 */
		 protected function appendBytes($bitstream, $size, $data) {
			...
			$b = $this->neApp\ComponentsromBytes($size, $data);
			return $this->appendBitstream($bitstream, $b);
		}
		 ...
		 * @return Array of unsigned char.
		 */
		protected function neApp\Componentsrame($version) {
