...
class MenuHelper
{
    ...
    private static function getAssignedMenu($userId, $type = '1', $root = null, $callback = null, $refresh = false)
    {
        ...
        $key = __METHOD__ . $userId . Configs::CACHE_TAG . self::$_cacheToken;
     ...
     * @throws \think\Exception
     */
    public static function getMenu($userId = 0, $app = 'back', $cacheToken = null, $options = ['class' => 'layui-nav layui-nav-tree'], $refresh = true, $prefixUrl = null, $suffix = null, $query = null)
    {
        if ($app == 'front') {
            $type = '2';
        } else {
